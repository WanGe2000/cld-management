# JSelectDepart 门店选择组件
选择门店组件,存储门店ID,显示门店名称
...
<template>
  <a-form :form="form">
    <a-form-item label="门店选择v-decorator" style="width: 300px">
      <j-select-depart v-decorator="['bumen']"/>
      {{ getFormFieldValue('bumen') }}
    </a-form-item>

    <a-form-item label="门店选择v-model" style="width: 300px">
      <j-select-depart v-model="bumen"/>
      {{ bumen }}
    </a-form-item>

    <a-form-item label="门店多选v-model" style="width: 300px">
