    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="vip等级">
          <a-input placeholder="请输入vip等级" v-decorator="['vipId', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'tenantId','departId','delFlag','name','idCard','iphone','vipId','sex','avatar'))
		  //时间格式化
