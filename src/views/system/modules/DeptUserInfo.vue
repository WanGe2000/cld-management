        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a-popconfirm title="确定取消与选中门店关联吗?" @confirm="() => handleDelete(record.id)">
                  <a>取消关联</a>
                </a-popconfirm>
              </a-menu-item>
              <a-menu-item>
                <a href="javascript:;" @click="handleDeptRole(record)">分配门店角色</a>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
        </span>
    ...
    methods: {
      ...
      batchDel: function () {
        ...
        if (!this.currentDeptId) {
          this.$message.error("未选中任何门店，无法取消门店与用户的关联!")
          return
        }
      ...
      handleAdd: function () {
        if (this.currentDeptId == '') {
          ...
          this.$refs.modalForm.departDisabled = true;
          this.$refs.modalForm.userDepartModel.departIdList = [this.currentDeptId];  //传入一个门店id
      ...
      handleDeptRole(record){
        ...
        this.$refs.deptRoleUser.title = "门店角色分配";
      }
    }
  }
</script>
