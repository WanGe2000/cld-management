    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="门店角色名称">
          <a-input placeholder="请输入门店角色名称" v-decorator="['roleName', validatorRules.roleName]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="门店角色编码">
          <a-input placeholder="请输入门店角色编码" v-decorator="['roleCode', validatorRules.roleCode]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
    ...
    data () {
      return {
        ...
        validatorRules:{
          roleName:{
            rules: [
              { required: true, message: '请输入门店角色名称!' },
              { min: 2, max: 30, message: '长度在 2 到 30 个字符', trigger: 'blur' }
            ]},
          roleCode:{
            rules: [
              { required: true, message: '请输入门店角色编码!'},
