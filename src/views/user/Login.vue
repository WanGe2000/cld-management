      ...
      <a-form>
        <a-form-item
          ...
          <a-tooltip placement="topLeft" >
            <template slot="title">
              <span>您隶属于多门店，请选择登录门店</span>
            </template>
            <a-avatar style="backgroundColor:#87d068" icon="gold" />
          </a-tooltip>
          <a-select @change="departChange" :class="{'valid-error':validate_status=='error'}" placeholder="请选择登录门店" style="margin-left:10px;width: 80%">
  ...
  export default {
    ...
    methods: {
      ...
      departChange(value){
        ...
        if(value){
          localStorage.setItem('depart',value)
        }
      },
    getRouterData(){
      this.$nextTick(() => {
