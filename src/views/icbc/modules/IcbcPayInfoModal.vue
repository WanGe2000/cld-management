  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="特约商户编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'merchantId', validatorRules.merchantId]" placeholder="请输入特约商户编号"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'appid','merchantId','apigwPublicKey','privateKey','publicKey','signType','encryptType','encryptKey','cerPrivateKey','cerPublicKey','cerPassword'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'appid','merchantId','apigwPublicKey','privateKey','publicKey','signType','encryptType','encryptKey','cerPrivateKey','cerPublicKey','cerPassword'))
      }
